                ...
                >
                    <Image
                        ...
                        style={{
                            width: 20,
                            height: 20,
                            tintColor: isFocused ? COLORS.darkbrown : COLORS.iconbrown
                        }}
                    />
...
const MainLayout = ({ drawerAnimationStyle, navigation, selectedTab, setSelectedTab }) => {
    ...
    React.useEffect(() => {
        if (selectedTab == constants.screens.home) {
            ...
            homeTabColor.value = withTiming(COLORS.tabcolor, { duration: 500 })
        }
        ...
        if (selectedTab == constants.screens.search) {
            ...
            searchTabColor.value = withTiming(COLORS.tabcolor, { duration: 500 })
        }
        ...
        if (selectedTab == constants.screens.cart) {
            ...
            cartTabColor.value = withTiming(COLORS.tabcolor, { duration: 500 })
        }
        ...
        if (selectedTab == constants.screens.favourite) {
            ...
            favouriteTabColor.value = withTiming(COLORS.tabcolor, { duration: 500 })
        }
        ...
        if (selectedTab == constants.screens.notification) {
            ...
            notificationTabColor.value = withTiming(COLORS.tabcolor, { duration: 500 })
        }
    }, [selectedTab])
    ...
    return (
        <Animated.View
            style={{
                flex: 1,
                backgroundColor: COLORS.bgc, // background color for
                overflow: 'hidden',
        ...
        >
            ...
            >
                ...
                <LinearGradient
                    ...
                    colors={[COLORS.transparent, COLORS.tabcolor]}
                    style={{
                        position: 'absolute',
                        top: -15,
                        left: 0,
