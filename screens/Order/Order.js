            ...
            >
                <TextButton
                    buttonContainerStyle={{
                        flex: 1,
                        borderRadius: SIZES.radius,
                        backgroundColor: (selectedTab == 'history') ? COLORS.darkbrown : COLORS.categorycolor
                    }}
                    label="History"
                    labelStyle={{
                        color: (selectedTab == 'history') ? COLORS.white : COLORS.black,
                    }}
                    onPress={() => {
                ...
                <TextButton
                    buttonContainerStyle={{
                        ...
                        borderRadius: SIZES.radius,
                        backgroundColor: (selectedTab == 'upcoming') ? COLORS.darkbrown : COLORS.categorycolor
                    }}
                    label="Upcoming"
                    labelStyle={{
                        color: (selectedTab == 'upcoming') ? COLORS.white : COLORS.black,
                    }}
                    onPress={() => {
