        ...
        <View>
            ...
            >
                ...
                <TouchableOpacity
                    onPress={onPress}
                >
                    <Text style={{ color: COLORS.darkbrown, ...FONTS.body3 }}>
                        Show All
                    </Text>
                </TouchableOpacity>
            </View>
            ...
            <FlatList
                ...
                renderItem={({ item, index }) => (
                    ...
                    >
                        <Text
                            style={{
                                color: selectedMenuType == item.id ? COLORS.darkbrown : COLORS.black,
                                ...FONTS.h3
                            }}
                        >
                            {item.name}
                ...
                renderItem={({ item, index }) => (
                    <TouchableOpacity
                        style={{
                            ...
                            paddingHorizontal: 8,
                            borderRadius: SIZES.radius,
                            backgroundColor: selectedCategoryId == item.id ? COLORS.darkbrown : COLORS.categorycolor
                        }}
                        onPress={() => {
