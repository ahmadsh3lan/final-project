    ...
    function renderCard() {
        return (
            ...
            >
                ...
                >
                    <Text style={{ color: COLORS.black, ...FONTS.h3 }}>{cardName}</Text>
                    <View
                        style={{
                            flexDirection: 'row'
                        }}
                    >
                        <Text style={{ flex: 1, color: COLORS.black, ...FONTS.body3 }}>{cardNumber}</Text>
                        <Text style={{ color: COLORS.black, ...FONTS.body3 }}>{expiryDate}</Text>
                    </View>
                </View>
            </ImageBackground>
        )
