            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: COLORS.black, ...FONTS.body4 }}>Your delivery time</Text>
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: COLORS.black, ...FONTS.body4 }}>Your address</Text>
                            <Text style={{ ...FONTS.h3 }}>Abrhim Avino 31 , Beer Sheva </Text>
                        </View>
                    </View>
                    ...
                    >
                        ...
                        <View style={{ flex: 1, marginLeft: SIZES.radius }}>
                            <Text style={{ color: COLORS.darkbrown, ...FONTS.h3 }}>Yaseen Gnaiem</Text>
                            <Text style={{ color: COLORS.darkbrown, ...FONTS.body4 }}>Delivery Man</Text>
                        </View>
